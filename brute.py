...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Leader</>                |"
    print GL+"  |            became a programmer              |"
    print WW+"  |            TELEGRAM: xm316                  |"
    print Y+"   |             INSTAGRAM: xm.316               |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ @xm316 ]        |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FACEBOOK tool      •••••••••|"
    print GG+"  √=============================================√"

banner()

print wd+"         https://www.github.com/xm316 "
        ...
        -o:  -.......        ..       `:o-
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              ...
              Powered by:\033[97m sakill Hack
      """
